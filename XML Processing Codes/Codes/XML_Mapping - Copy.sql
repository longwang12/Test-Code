...
INTO [CreditReport].[dbo].[xMain]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xTradeLine]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xTradeLineMsg]
FROM [CreditReport].[dbo].[XMLdt]
	CROSS APPLY ResponseXML.nodes('/GetReportResponse/GetReportResult/Subject/Liability') AS sub(liability)
	OUTER APPLY sub.liability.nodes('./OrgInfo') AS t10(OrgInfo)
	OUTER APPLY t10.OrgInfo.nodes('./OrgId') AS t11(OrgId)
...
INTO [CreditReport].[dbo].[xTradeLinePmtInfo]
FROM [CreditReport].[dbo].[XMLdt]
	CROSS APPLY ResponseXML.nodes('/GetReportResponse/GetReportResult/Subject/Liability') AS sub(liability)
	OUTER APPLY sub.liability.nodes('./OrgInfo') AS t10(OrgInfo)
	OUTER APPLY t10.OrgInfo.nodes('./OrgId') AS t11(OrgId)
...
INTO [CreditReport].[dbo].[xCollection]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xPubRecord]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xEmployment]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xContact]
FROM [CreditReport].[dbo].[XMLdt]
...
SELECT a.*
INTO [CreditReport].[dbo].[xMessage]
From
(
-- Message
	SELECT ID as RID,
...
INTO [CreditReport].[dbo].[xTINinfo]
FROM [CreditReport].[dbo].[XMLdt]
...
SELECT ID as RID,
	...
	sub1.val.value('(Text)[1]','varchar(255)') as Text
INTO [CreditReport].[dbo].[xStatement]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xConsumerReferral]
FROM [CreditReport].[dbo].[XMLdt]
...
INTO [CreditReport].[dbo].[xFileStatus]
FROM [CreditReport].[dbo].[XMLdt]
